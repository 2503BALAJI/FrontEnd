...
const Vision = () => {
  return (
    <div className="bg-white w-full py-16 px-6 md:px-16 lg:px-32">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start mt-12 space-y-8 md:space-y-0 md:space-x-8">
        {/* Our Mission */}
        <div className="flex-1 bg-white rounded-lg shadow-lg overflow-hidden p-6 md:p-8">
          <h3 className="text-xl md:text-2xl lg:text-3xl font-semibold mb-4 text-gray-900">
            Our Mission
          </h3>
