...
const Contact_us = () => {
  ...
  return (
    <div className="h-full  py-12  w-full bg-contain "
    ...
    >
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <img src={email_icon} alt='email png' className='p-3'/>
          ...
          >
            ...
            {/* <a href="#" className="text-blue-500 underline">Submit a Ticket</a> */}
        </div>

          {/* CALL Section */}
         <div className="bg-white bg-opacity-80 p-6 rounded-lg  flex  flex-col  justify-center        items-center  shadow-lg">
           <img src={call_icon}  alt="call icon" className='p-3'/>
            {/* <FaPhone className="mx-auto text-6xl mb-4" /> */}
        ...
        <div className="bg-white bg-opacity-80 p-6 flex  flex-col  justify-center items-center rounded-lg shadow-lg">
            <img src={chat_icon} alt='chat icon img' className='p-3' />
            {/* <FaCommentDots className="mx-auto text-6xl mb-4" /> */}
            <h2 className="text-2xl font-bold mb-2">CHAT</h2>
            <a href='https://wa.me/9834XXXX' target="_blank" rel="noopener noreferrer">On WhatsApp</a>

              {/* ............................ mobile no. takaycha baki ahe .............. */}
        ...
        <div className='flex justify-center items-center md:flex-col'>
          ...
          <div className="mt-12 text-center">
            ...
            <p>Press Inquiries: <a href="mailto:media@honest.com" className="text-blue-500 underline">media@honest.com</a></p>
            <p>Influencer Inquiries: <a href="mailto:influencers@honest.com" className="text-blue-500 underline">influencers@honest.com</a></p>
            <p>Social Brand Partnerships: <a href="mailto:social@honest.com" className="text-blue-500 underline">social@honest.com</a></p>
            <p>Giving: <a href="mailto:socialgoodness@honest.com" className="text-blue-500 underline">socialgoodness@honest.com</a></p>
          </div>
        </div>
